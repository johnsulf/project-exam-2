...
// Status = “Has upcoming bookings” when any dateTo is in the future
...
export default function ManageVenueDetail() {
  ...
  // Build disabled ranges for the calendar (check-out day is typically free → disable up to dateTo - 1 day)
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Read-only booked dates calendar */}
