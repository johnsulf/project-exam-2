    ...
    >
      <div className="relative h-56 overflow-hidden">
        {imageUrl ? (
          ...
          <div className="flex h-full w-full items-center justify-center bg-linear-to-br from-neutral-200 via-neutral-300 to-neutral-400 text-sm font-medium textext-muted-foreground600">
            No image available
          </div>
        )}
